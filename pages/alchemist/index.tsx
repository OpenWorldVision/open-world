          ...
          <div>
              <div className="container-alchemist" > 
                  ...
                  >
                      <TransformComponent>
                        <div
                            className="alchemist container transform-component"
                        >
                          <AlchemistBgAnimate />
                          <HeroAlchemist />
                          <AlchemistBtnAnimate top={242.868} left= {518.216} contentButton='Alchemist' />
                          <button onClick={() =>{setIsAlchemistModalOpenn(true)}} className="layout-btn btn-alchemist cursor-btn">
                          </button>
                        </div>
                      </TransformComponent>
                  </TransformWrapper>
