        ...
        <WorldMap>
          ...
          >
            <div className='containerWorldMap'>
              ...
              <a href='/castle' className='castle' onClick={() => { console.log('nam') }}>
                <img src='/images/Castle.png' alt='img' />
                <button></button>
              </a>
              <a href='/portal' className='portal' onClick={() => { console.log('nam') }}>
                <img src='/images/Portal.png' alt='img' />
                <button></button>
              </a>
              <a href='/marketplace' className='marketplace' onClick={() => { console.log('nam') }}>
                <img src='/images/Marketplace.png' alt='img' />
                <button></button>
              </a>
              <a href='/docks' className='docks' onClick={() => { console.log('nam') }}>
                <img src='/images/Docks.png' alt='img' />
                <button></button>
              </a>
              <a href='/professions' className='professions' onClick={() => { console.log('nam') }}>
                <img src='/images/Professions.png' alt='img' />
                <button></button>
              </a>
              <a href='/gardens' className='gardens' onClick={() => { console.log('nam') }}>
                <img src='/images/Gardens.png' alt='img' />
                <button></button>
              </a>
              <a href='/tavern' className='tavern' onClick={() => { console.log('nam') }}>
                <img src='/images/Tavern.png' alt='img' />
                <button></button>
              </a>
              <a href='/jeweler' className='jeweler' onClick={() => { console.log('nam') }}>
                <img src='/images/Jeweler.png' alt='img' />
                <button></button>
              </a>
              <a href='/alchemist' className='alchemist' onClick={() => { console.log('nam') }}>
                <img src='/images/Alchemist.png' alt='img' />
                <button></button>
              </a>
              <a href='/meditation_circle' className='meditation_circle' onClick={() => { console.log('nam') }}>
