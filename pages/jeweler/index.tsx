                ...
                <div className="modal__body__container">
                  ...
                  >
                    <div className="border_content">
                      ...
                      <div className="body">
                        Thank you for being a valued client! If you have locked
                        JEWEL, I can assist you with transferring it to another
                        wallet. I can only transfer the full balance, so make
                        sure you want to move everything!
                      </div>
                    </div>
                    <div className="introduce">
                      <div>
                        ...
                        this function if your wallet has been compromised or if
                        you are moving to a hardware wallet.
                      </div>
                      <div>
                        You can only transfer the full balance of your locked
                        JEWEL. Only wallets with active DeFi Kingdoms accounts
                        may receive locked JEWEL.
                      </div>
                      <div>
                        All unclaimed rewards should be claimed prior to
                        transfer. Additionally, all JEWEL in the transferring
                        wallet will be moved to the new wallet when using this
                        feature. If you do not wish to move your unlocked JEWEL,
                        deposit it with the Jeweler before using this transfer
                        option. xJEWEL will not be transferred and will need to
                        be sent manually.
                      </div>
                      <div>
                        The recipient wallet address must be different from the
                        current wallet. If you try to transfer locked JEWEL to
                        the same wallet that it is already in, it will be lost
                        forever.
                      </div>
                    </div>
                    ...
                    <div style={{ padding: '10px 15px' }}>
                      <div className="warning">
                        ...
                        <p>
                          Warning: This process is irreversible. There is no way
                          to cancel or undo this transfer, so be sure that you
                          entered the correct wallet address and that it is not
                          the same wallet that contains the locked JEWEL that
                ...
                <div className="modal__body__container">
                  ...
                  >
                    <div className="border_content">
                      ...
                      <div className="body">
                        Welcome to Adelyn, the greatest city in Serendale! You
                        can deposit your JEWEL here at the Jeweler, and visit
                        the Marketplace to trade tokens. Lazarus the Druid is
                        also there; he can help you acquire seeds which you can
                        plant in the Gardens to participate in liquidity pools
                        and earn rewards!
                      </div>
                      <div className="footer">
                        You can find Heroes for sale in the Tavern, or visit the
                        Portal to Summon new ones. Again, welcome, and enjoy
                        your stay! If you need more information about anything
                        you find here, visit docs.defikingdoms.com to learn
                        more.
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="popup-jeweler-body">
                      ...
                      <div className="dex-fee">
                        <div className="dex-fee-head">
                          ...
                          <div>
                            Stake your JEWEL tokens and earn 1/3rd of generated
                            trading fees.
                          </div>
                        </div>
                        <div className="dex-fee-body bordered-box bordered-box-hero">
                          ...
                          <div className="your-token">
                            You have <span>0.00</span> JEWEL tokens available to
                            deposit to the Jeweler.
                          </div>
                        </div>
                      </div>
                      <div className="popup-jeweler-body-msg">
                        ...
                        Tokens are 100% unlocked when they are claimed. The
                        Jeweler does not have any withdrawal fees.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        When you claim rewards, collected LP fees will be used
                        to market buy JEWEL.
                      </p>
                      ...
                      >
                        The purchased JEWEL tokens will then be distributed to
                        the Jeweler stakers as a reward.
                      </p>
                    </div>
                  </div>
                  <button
