          ...
          <div>
            <div className="container-jeweler" >
              ...
              <Modal isOpen={modalIsOpen} onClose={() => { setIsOpen(false) }}>
                ...
                >
                  <ModalHeader style={{ background: 'rgba(0, 0, 0, 0.9)' }}>Locked JEWEL Management</ModalHeader>
                  <ModalCloseButton style={{ boxShadow: 'none' }} className='cursor-btn' />
                  <ModalBody>
              ...
              <Modal isOpen={modalInfo} onClose={() => { setModalInfo(false) }}>
                ...
                >
                  <ModalHeader style={{ background: 'rgba(0, 0, 0, 0.9)' }}>Info</ModalHeader>
                  <ModalCloseButton style={{ boxShadow: 'none' }} className='cursor-btn' />
                  <ModalBody>
                    <div className="modal__body__container">
              ...
              <Modal isOpen={modalLila} onClose={() => { setModalLila(false) }}>
                ...
                >
                  <ModalHeader style={{ background: 'rgba(0, 0, 0, 0.9)' }}>Lila</ModalHeader>
                  <ModalCloseButton style={{ boxShadow: 'none' }} className='cursor-btn' />
                  <ModalBody>
                    <div className="modal__body__container">
              ...
              <Modal isOpen={modalJeweler} onClose={() => { setModalJeweler(false) }}>
                ...
                >
                  <ModalHeader style={{ background: 'rgba(0, 0, 0, 0.9)' }}>Jeweler</ModalHeader>
                  <ModalCloseButton style={{ boxShadow: 'none' }} className='cursor-btn' />
                  <ModalBody>
                    <div className="modal__body__container">
