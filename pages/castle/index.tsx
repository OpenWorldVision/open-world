                ...
                <TransformComponent wrapperStyle={{height: '100vh', width: '100vw'}}>
                    ...
                    >
                        ...
                        >
                            ...
                            {/* hall light  */}
                            <div className={ `${style.hallLightWrap} ${style.hallLightWrap1}` }>
                                <div className={ style.hallLight }></div>
                            </div>

                            <div className={ `${style.hallLightWrap} ${style.hallLightWrap2}` }>
                                <div className={ style.hallLigh }></div>
                            </div>

                            <div className={ `${style.hallLightWrap} ${style.hallLightWrap3}` }>
                                <div className={ style.hallLight }></div>
                            </div>
                            ...
                            {/* throne light  */}
                            <div className={ `${style.throneLightWrap} ${style.throneLightWrap}` }>
